...
/**
 * Version of fast-check used by your project (eg.: 2.8.0)
 * @public
 */
declare const __version: string;
/**
 * Commit hash of the current code (eg.: 4424096ea12a452569759b8a882b7c7470ac294d)
 * @public
 */
...
export { __type, __version, __commitHash, sample, statistics, check, assert, pre, PreconditionFailure, property, asyncProperty, IRawProperty, IProperty, IPropertyWithHooks, IAsyncProperty, IAsyncPropertyWithHooks, AsyncPropertyHookFunction, PropertyHookFunction, boolean, falsy, float, double, integer, nat, maxSafeInteger, maxSafeNat, bigIntN, bigUintN, bigInt, bigUint, char, ascii, char16bits, unicode, fullUnicode, hexa, base64, mixedCase, string, asciiString, string16bits, stringOf, unicodeString, fullUnicodeString, hexaString, base64String, lorem, constant, constantFrom, clonedConstant, mapToConstant, option, oneof, frequency, clone, dedup, shuffledSubarray, subarray, array, infiniteStream, set, tuple, genericTuple, record, dictionary, anything, object, json, jsonObject, unicodeJson, unicodeJsonObject, letrec, memo, compareBooleanFunc, compareFunc, func, context, date, ipV4, ipV4Extended, ipV6, domain, webAuthority, webSegment, webFragments, webQueryParameters, webUrl, emailAddress, uuid, uuidV, AsyncCommand, Command, ICommand, asyncModelRun, modelRun, scheduledModelRun, commands, ModelRunSetup, ModelRunAsyncSetup, scheduler, schedulerFor, Scheduler, SchedulerSequenceItem, SchedulerReportItem, Arbitrary, ArbitraryWithShrink, Shrinkable, cloneMethod, stringify, defaultReportMessage, hash, ArrayConstraints, BigIntConstraints, BigUintConstraints, CommandsContraints, DoubleConstraints, FalsyContraints, FloatConstraints, FloatNextConstraints, IntegerConstraints, JsonSharedConstraints, LoremConstraints, MixedCaseConstraints, NatConstraints, ObjectConstraints, OptionConstraints, RecordConstraints, SchedulerConstraints, SetConstraints, StringSharedConstraints, SubarrayConstraints, WebAuthorityConstraints, WebUrlConstraints, WeightedArbitrary, CloneValue, ContextValue, DedupValue, FalsyValue, FrequencyValue, OneOfValue, RecordValue, Memo, GlobalParameters, GlobalAsyncPropertyHookFunction, GlobalPropertyHookFunction, Parameters, RandomType, VerbosityLevel, configureGlobal, readConfigureGlobal, resetConfigureGlobal, ExecutionStatus, ExecutionTree, RunDetails, RunDetailsFailureProperty, RunDetailsFailureTooManySkips, RunDetailsFailureInterrupted, RunDetailsSuccess, RunDetailsCommon, Random, Stream, stream, Context, FalsyType, };
